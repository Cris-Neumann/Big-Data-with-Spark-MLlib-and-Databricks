...
* Como paso previo, se debe crear un cluster, el cual para la versión Comunnity Edition, que es gratuita, posee 15 GB de memoria y 2 cores. Adjunto una imagen donde se muestra en qué lgugar debe crear el custer, en sección "compute":
<br/><br/>
